...
<body>
   ...
   <header class="menu-header">
      <nav class="menu-bar">
         <div class="container">
            <div id="toggle-menu">
               <img class="logo-menu" src="{{ asset('img/logo-4.png') }}" alt="">
               <i class="fa fa-bars fa-lg"></i>
            </div>
            <ul class="menu">
               <li><img class="logo-menu" src="{{ asset('img/logo-4.png') }}" alt=""></li>
               ...
               <li>
                  ...
                  @else
                       <a class="fancyinicio" href="{{ route('login') }}" data-fancybox-type="iframe">Iniciar</a>
                  @endif
               </li>
            </ul>
         </div>
   ...
   <section class="seccion-banner" id="section-1">
      <div class="owl-carousel owl-theme owl-large">
         <div class="item">
            <a href="{{ asset('img/banners/banner-text-1.png') }}" class="fancybox">
               <img src="{{ asset('img/banners/banner-1.1.jpg') }}" alt="banner1">
            </a>
         </div>
         <div class="item">
            <a href="{{ asset('img/banners/banner-text-2.png') }}" class="fancybox">
               <img src="{{ asset('img/banners/banner-2.1.jpg') }}" alt="banner2">
            </a>
         </div>
         <div class="item">
            <a href="{{ asset('img/banners/banner-text-3.png') }}" class="fancybox">
               <img src="{{ asset('img/banners/banner-3.1.jpg') }}" alt="banner3">
            </a>
         </div>
      </div>
      <div class="owl-carousel owl-theme owl-small">
         <div class="item">
            <a href="{{ asset('img/banners/banner-text-1.png') }}" class="fancybox">
               <img src="{{ asset('img/banners/banner-1.jpg') }}" alt="banner1">
            </a>
         </div>
         <div class="item">
            <a href="{{ asset('img/banners/banner-text-2.png') }}" class="fancybox">
               <img src="{{ asset('img/banners/banner-2.jpg') }}" alt="banner2">
            </a>
         </div>
         <div class="item">
            <a href="{{ asset('img/banners/banner-text-3.png') }}" class="fancybox">
               <img src="{{ asset('img/banners/banner-3.jpg') }}" alt="banner3">
            </a>
         </div>
      </div>
   </section>
   ...
   <section class="seccion-azul">
      <!--<div class="container">-->
         <div class="seccion-info">
            <a href="{{ asset('img/banners/banner-text-1.png') }}" rel="group" class="fancybox">
               <span class="item-icon">
                  <i class="fa fa-search-plus"></i>
               </span>
               <img src="{{ asset('img/info-1.png') }}" alt="info-1.png">
            </a>
            <a href="{{ asset('img/banners/banner-text-2.png') }}" rel="group" class="fancybox">
               <span class="item-icon">
                  <i class="fa fa-search-plus"></i>
               </span>
               <img src="{{ asset('img/info-2.png') }}" alt="info-2.png">
            </a>
            <a href="{{ asset('img/banners/banner-text-3.png') }}" rel="group" class="fancybox">
               <span class="item-icon">
                  <i class="fa fa-search-plus"></i>
               </span>
               <img src="{{ asset('img/info-3.png') }}" alt="info-3.png">
            </a>
            <a href="{{ asset('img/banners/banner-text-4.png') }}" rel="group" class="fancybox">
               <span class="item-icon">
                  <i class="fa fa-search-plus"></i>
               </span>
               <img src="{{ asset('img/info-4.png') }}" alt="info-4.png">
            </a>
         </div>
      <!--</div>-->
   </section>
         ...
         <div class="contacto">
            <div class="items-flex">
               <div>
                  ...
                  <img src="{{ asset('img/logo-eata.jpg') }}" alt="">
               </div>
               <div>
                  <p>Dirección:</p>
